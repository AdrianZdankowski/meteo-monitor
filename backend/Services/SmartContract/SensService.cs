...
namespace backend.Services
{
    public partial class SensService
    {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, SensDeployment sensDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<SensDeployment>().SendRequestAsync(sensDeployment);
        }
        ...
        public SensService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
